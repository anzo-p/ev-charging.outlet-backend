...
import outlet.backend.mocks.{MockChargerOutletService, MockChargingEventProducer}
import outlet.backend.types.chargerOutlet.ChargerOutlet
import outlet.backend.types.outletDeviceMessage.Fixtures.fixtureBasicDeviceMessage
